...
class PersonaController {
    ...
    def index(Integer max) {
        ...
        def personaList = personaService.list(params)
        def personaCount = personaService.count()
        render view: 'index', model: [personaList: personaList, personaCount: personaCount]
    }
